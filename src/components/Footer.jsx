                ...
                <div className="footer-top top row-span-2 items-start">
                    ...
                    <div className="top-rules">
                        <ul className='top-list'>
                            ...
                            <li  className='relative'
                                ...
                                >{isSupport && <span className='absolute top-7 left-1/2 transform -translate-x-1/2 bg-gray-800 text-white text-xs rounded py-1 px-2'>в процесі наповнення</span>}
                                    <a  href="#">Підтримка</a></li     >
                            <li className='relative'
                                onClick={(e) => {
                                e.preventDefault()
                                setIsFacebook(true)}}
                                onMouseLeave={() => setIsFacebook(false)}
                                >{isFacebook && <span className='absolute top-7 left-1/2 transform -translate-x-1/2 bg-gray-800 text-white text-xs rounded py-1 px-2'>в процесі наповнення</span>}
                                    <a data-name='в процесі наповнення' href="#">Facebook</a></li>
                            <li className='relative'
                                onClick={(e) => {
                                e.preventDefault()
                                setIsTikTok(true)}}
                                onMouseLeave={() => setIsTikTok(false)}
                                >{isTikTok && <span className='absolute top-7 left-1/2 transform -translate-x-1/2 bg-gray-800 text-white text-xs rounded py-1 px-2'>в процесі наповнення</span>}
                            ...
                            <li className='relative'
                                ...
                                >{isTelegram && <span className='absolute top-7 left-1/2 transform -translate-x-1/2 bg-gray-800 text-white text-xs rounded py-1 px-2'>в процесі наповнення</span>}
                            ...
                            <li className='relative'
                                ...
                                >
                                {isInstagram && <span className='absolute top-7 left-1/2 transform -translate-x-1/2 bg-gray-800 text-white text-xs rounded py-1 px-2'>в процесі наповнення</span>}
                    ...
                    <div className="top-social social">
                        <ul className='social-list' >
                            ...
                            >
                                {isLinkedIn && <span className='absolute -top-13 left-1/2 transform -translate-x-1/2 bg-gray-800 text-white text-xs rounded py-1 px-2'>в процесі наповнення</span>}
                    ...
                    <ul className='bottom-list'>
                        ...
                        <li
                            ...
                            onClick={(e)=>{
                                e.preventDefault()
                                setIsPolice(true)}}
                                onMouseLeave={()=>{setIsPolice(false)}}
                        >
                            {isPolice && <span className='absolute -top-13 left-1/2 transform -translate-x-1/2 bg-gray-800 text-white text-xs rounded py-1 px-2'>в процесі наповнення</span>}
